...
signal.SIGCHILD = 5 -- a parent's child process terminated
signal.SIGUSR1 = 6 -- use however you want! very simple interprocess communication
signal.SIGUSR2 = 7 -- use however you want! very simple interprocess communication
signal.SIGWINCH = 8 -- the window or terminal dimensions changed
